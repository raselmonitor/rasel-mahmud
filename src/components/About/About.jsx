...
const About = () => {
    return (
        <div className="w-11/12 lg:container lg:px-16 mx-auto pt-20 grid grid-cols-1 md:grid-cols-3 gap-10" id="about">
            ...
            <div
                ...
                data-aso className="md:col-span-2 shadow-lg p-6 rounded-lg">
                <div >
                ...
                <div className="font-mont text-[17px] text-black text-justify mt-5">
                ...
                <div className="flex flex-col md:flex-row gap-6 justify-between mt-5">
